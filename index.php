    ...
    <div class="form-center-mid">
        <div class="form_page">
            <div class="col l12 center">
                <div class="title col s12 "><h1>MA inschrijf formulier versturen</h1></div>
                <div class="row">
                    <div class="col s10 offset-s1 m6 offset-m3 l4 offset-l4">

                        <div class="row">
                            <div class="input-field col s12">
                                <input id="uw_naam" name="uw_naam" type="text" class="validate">
                                <label for="uw_naam">Uw naam</label>
                            </div>
                            <div class="input-field col s12">
                                <input id="uw_email" name="uw_email" type="email" class="validate">
                                <label for="uw_email">Uw email</label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input id="email_mentor" name="email_mentor" type="email" class="validate">
                                <label for="email_mentor">Email mentor</label>
                            </div>
                        </div>
                        <a class="waves-effect waves-light btn-small" id="versturen">Versturen</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="form_page">
            <div class="title col s12 pink-text"><h1>MA inschrijf formulier is verzonden</h1></div>
            <div class="col s12 center">Het formulier is verzonden naar uw mentor <br>
                Wanneer uw mentor het formulier heeft ingevuld, sturen wij u een mailtje terug met het ingevulde formulier.<br>
                U kunt zelf daarna beslissen of u het formulier doorstuurt naar MA.</div>
        </div>
    </div>
